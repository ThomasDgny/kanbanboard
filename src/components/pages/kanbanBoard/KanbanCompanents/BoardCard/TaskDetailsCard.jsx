        ...
        <div className='CreateCardPopUp fixed z-[100] top-0 bottom-0 left-0 w-[80vh] bg-white drop-shadow-md overflow-y-scroll scroll-smooth scrollbar-hide'>
            <div className='CreateCardPopUp_Body p-6'>
                <form className='flex flex-col w-full gap-6' onSubmit={createNewTask}>
                    ...
                    <input type="text" className='bg-transparent border-none outline-0 text-[32px] font-bold p-2 border text-gray-700 rounded-lg resize-none' defaultValue={title} required placeholder='Untitled' onChange={(e) => setTitle(e.target.value)} />
                    ...
                    <input type="submit" className="sticky cursor-pointer drop-shadow-lg shadow-[#1DA1F2] bottom-5 left-5 right-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-3 mr-2 mb-2" value={'Update'} />
